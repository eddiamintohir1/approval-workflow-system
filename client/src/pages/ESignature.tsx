        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Send documents for electronic signature through Compawnion&apos;s
              Microsoft cloud
            </p>
          </div>
        </div>
        ...
        <TabsContent value="esign" className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                disabled={uploading || !file || !!uploadedDocId}
                className="w-full"
              >
                {uploading ? (
                  <>
          ...
          {uploadedDocId && uploadedDocUrl && (
            <Card className="border-primary">
              <CardHeader>
                ...
                <CardDescription>
                  Open HelloDoc, add signature fields, and send the document
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <Alert>
                  <AlertDescription className="space-y-3">
                    <p className="font-medium">
                      Document uploaded successfully! Follow these steps:
                    </p>
                    <ol className="list-decimal list-inside space-y-2 text-sm">
                      <li>
                        Click the button below to open HelloDoc/Dropbox Sign
                      </li>
                      <li>
                        Create a new signature request and upload this document:{" "}
                        <code className="text-xs bg-muted px-1 py-0.5 rounded">
                          {documentName}
                        </code>
                      </li>
                      <li>
                        Add signature, date, and initial fields where needed
                      </li>
                      <li>
                        Enter signer details: <strong>{signerName}</strong> (
                        {signerEmail})
                      </li>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    />
                    <Button
                      onClick={handleSubmitHelloDocId}
                      disabled={!helloDocId}
                    >
                      Save ID
                    </Button>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Find the Document ID in HelloDoc's dashboard after sending
                    the document
                  </p>
                </div>
              </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monitor signature status and download signed documents
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="awaiting_hellodoc_id">
                      Awaiting ID
                    </SelectItem>
        ...
        <TabsContent value="ematerai" className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Electronic stamp service integration (Coming Soon)
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Alert>
                ...
                <AlertDescription>
                  E-Materai integration is currently under development. This
                  feature will allow you to add electronic stamps to your
                  documents.
                </AlertDescription>
              </Alert>
            </CardContent>
