        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Welcome to the CJB Workflow Management System ("System"). This
              Privacy Policy explains how{" "}
              <strong>Compawnion Jadi Berkat</strong>, operated by{" "}
              <strong>Eddie Amintohir</strong> ("we," "us," or "our"), collects,
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              <li>
                ...
                employees and departments for workflow processing
              </li>
              <li>
                <strong>Service Providers:</strong> With trusted third-party
                services for hosting, analytics, and system maintenance
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              data, including encryption, Microsoft Entra authentication, access
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Workflow data may be retained for audit and compliance purposes.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We use cookies and similar tracking technologies to maintain user
              sessions, remember preferences, and analyze system usage. You can
              control cookie settings through your browser, but disabling
              cookies may affect system functionality.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              notify users of significant changes via email or system
              notification. Continued use of the System after changes
