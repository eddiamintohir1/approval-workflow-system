...
// Database connection
// ⚠️ GUARDRAIL: This pool is the single shared MySQL connection for the entire app.
// Import `mysqlPool` (or `db` for Drizzle ORM) from this file — never create a new pool elsewhere.
